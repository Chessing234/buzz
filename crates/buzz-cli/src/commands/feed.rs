...
/// Default and maximum `--limit` for `feed get`.
const FEED_LIMIT_DEFAULT: u32 = 20;
const FEED_LIMIT_MAX: u32 = 50;
...
pub async fn cmd_get_feed(
    ...
    let limit = effective_limit(requested_limit, FEED_LIMIT_DEFAULT, FEED_LIMIT_MAX);
